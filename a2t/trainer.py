"""
Adapted from textattack Trainer Class
======================================
"""
...
from textattack import CommandLineTrainingArgs, TrainingArgs

from adv_dataset import AdversarialDataset
...
class Trainer:
    ...
    def __init__(
        ...
        if self.task_type == "undersensitivity":
